...
[lastbreach](https://github.com/barbalet/lastbreach) is a post-apocalypse shelter simulation about routine, scarcity, tools, morale, repairs, food, water, and everyday survival after the dramatic event has already happened. [jungle](https://github.com/barbalet/jungle) is a first-person jungle perspective for the Mac. [musictodriveby](https://github.com/barbalet/musictodriveby) is an urban 3D engine. [werewolf](https://github.com/barbalet/werewolf) is a C to Java, JavaScript, Ruby, and Python transpiler. [png2json](https://github.com/barbalet/png2json) turns PNG files into JSON descriptions.
